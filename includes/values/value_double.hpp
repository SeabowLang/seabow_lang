...
{
public:
    SBW_ValueDouble(sbw_double val);
    SBW_ValueDouble(sbw_double *val);
    inline virtual ~SBW_ValueDouble() { if (this->value) free(this->value); }

    inline sbw_value_type Type(sbw_none) const { return VT_DOUBLE_; }

    inline sbw_double Get(sbw_none) const { return this->value ? *this->value : 0; }
