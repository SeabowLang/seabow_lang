...
SBW_ValueUint::SBW_ValueUint(sbw_uint val)
{
    this->value = (sbw_uint*)malloc(sizeof(sbw_uint));
    (*this->value) = val;
}
...
SBW_ValueUint::SBW_ValueUint(sbw_uint *val)
{
    if (val)
    {
        ...
        this->value = (sbw_uint*)0;
}

SBW_Value *SBW_ValueUint::AutoConvert(sbw_value_type dest_type)
{
    if (this->value)
    {
        switch (dest_type)
    ...
    else
    {
        switch (dest_type)
        {
            ...
            case VT_ANY_: return new SBW_ValueAny(new SBW_ValueUint((sbw_uint*)0));
            default: return this->AutoConvertionError(dest_type);
        }
    }    
}

SBW_Value *SBW_ValueUint::operator+(sbw_none) { if (!this->value) return this->OpWithNullError(L"left +"); return new SBW_ValueUint(*this->value); }

SBW_Value *SBW_ValueUint::operator+(SBW_Value *val)
{
    sbw_uint v = this->value ? *this->value : 0;
...
SBW_Value *SBW_ValueUint::operator++(sbw_none)
{
...
SBW_Value *SBW_ValueUint::operator++(int)
{
    if (!this->value) return this->OpWithNullError(L"right ++");
    SBW_ValueUint *old = new SBW_ValueUint((*this->value));
    (*this->value)++;
    return old;
}

SBW_Value *SBW_ValueUint::operator-(sbw_none) { if (!this->value) return this->OpWithNullError(L"left -"); return new SBW_ValueLong(-(*this->value)); }
...
SBW_Value *SBW_ValueUint::operator_power(SBW_Value *val)
{
    sbw_uint v = this->value ? *this->value : 0;
...
SBW_Value *SBW_ValueUint::operator_power_eq(SBW_Value *val)
{
    if (!this->value)
        return this->OpWithNullError(L"**=");
...
SBW_Value *SBW_ValueUint::operator~(sbw_none) { if (!this->value) return this->OpWithNullError(L"~"); return new SBW_ValueUint(~(*this->value)); }
...
SBW_Value *SBW_ValueUint::operator!(sbw_none) { if (this->value) return new SBW_ValueBoolean((*this->value) == 0); return new SBW_ValueBoolean(true); }
...
SBW_Value *SBW_ValueUint::operator*(sbw_none) { return new SBW_ValuePointer(this, this->Type()); }

SBW_Value *SBW_ValueUint::operator_convert(sbw_value_type dest_type)
{
    if (this->value)
    {
        switch (dest_type)
...
SBW_Value *SBW_ValueUint::operator_abs(sbw_none) { return this->value ? new SBW_ValueUint(*this->value) : new SBW_ValueUint((sbw_uint*)0); }