...
SBW_ValueUshort::SBW_ValueUshort(sbw_ushort val)
{
    this->value = (sbw_ushort*)malloc(sizeof(sbw_ushort));
    (*this->value) = val;
}
...
SBW_ValueUshort::SBW_ValueUshort(sbw_ushort *val)
{
    if (val)
    {
        ...
        this->value = (sbw_ushort*)0;
}

SBW_Value *SBW_ValueUshort::AutoConvert(sbw_value_type dest_type)
{
    if (this->value)
    {
        switch (dest_type)
        {
            ...
            case VT_ANY_:  return new SBW_ValueAny(new SBW_ValueUshort(*this->value));
    ...
    else
    {
        switch (dest_type)
        {
            ...
            case VT_ANY_:  return new SBW_ValueAny(new SBW_ValueUshort((sbw_ushort*)0));
            default:  return this->AutoConvertionError(dest_type);
        }
    }    
}

SBW_Value *SBW_ValueUshort::operator+(sbw_none) { if (!this->value) return this->OpWithNullError(L"left +"); return new SBW_ValueUshort(*this->value); }

SBW_Value *SBW_ValueUshort::operator+(SBW_Value *val)
{
    sbw_ushort v = this->value ? *this->value :  0;
...
SBW_Value *SBW_ValueUshort::operator++(sbw_none)
{
...
SBW_Value *SBW_ValueUshort::operator++(int)
{
    if (!this->value) return this->OpWithNullError(L"right ++");
    SBW_ValueUshort *old = new SBW_ValueUshort((*this->value));
    (*this->value)++;
    return old;
}

SBW_Value *SBW_ValueUshort::operator-(sbw_none) { if (!this->value) return this->OpWithNullError(L"left -"); return new SBW_ValueInt(-(*this->value)); }
...
SBW_Value *SBW_ValueUshort::operator_power(SBW_Value *val)
{
    sbw_ushort v = this->value ? *this->value :  0;
...
SBW_Value *SBW_ValueUshort::operator_power_eq(SBW_Value *val)
{
    if (!this->value)
        return this->OpWithNullError(L"**=");
...
SBW_Value *SBW_ValueUshort::operator~(sbw_none) { if (!this->value) return this->OpWithNullError(L"~"); return new SBW_ValueUshort(~(*this->value)); }
...
SBW_Value *SBW_ValueUshort::operator!(sbw_none) { if (this->value) return new SBW_ValueBoolean((*this->value) == 0); return new SBW_ValueBoolean(true); }
...
SBW_Value *SBW_ValueUshort::operator*(sbw_none) { return new SBW_ValuePointer(this, this->Type()); }

SBW_Value *SBW_ValueUshort::operator_convert(sbw_value_type dest_type)
{
    if (this->value)
    {
        switch (dest_type)
        {
            ...
            case VT_TYPE_:  return new SBW_ValueType(VT_USHORT_);
...
SBW_Value *SBW_ValueUshort::operator_abs(sbw_none) { return this->value ? new SBW_ValueUshort(*this->value) :  new SBW_ValueUshort((sbw_ushort*)0); }