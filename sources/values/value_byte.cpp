...
{
    this->value = (sbw_byte*)malloc(sizeof(sbw_byte));
    (*this->value) = val;
}
...
SBW_ValueByte::SBW_ValueByte(sbw_byte *val)
{
    if (val)
        ...
        this->value = (sbw_byte*)0;
}

SBW_Value *SBW_ValueByte::AutoConvert(sbw_value_type dest_type)
{
    if (this->value)
    {
        switch (dest_type)
        {
            ...
            case VT_ANY_: return new SBW_ValueAny(new SBW_ValueByte(*this->value));
    ...
    else
    {
        switch (dest_type)
        {
            ...
            case VT_ANY_: return new SBW_ValueAny(new SBW_ValueByte((sbw_byte*)0));
            default: return this->AutoConvertionError(dest_type);
        }
    }    
}

SBW_Value *SBW_ValueByte::operator+(sbw_none) { if (!this->value) return this->OpWithNullError(L"left +"); return new SBW_ValueByte(*this->value); }

SBW_Value *SBW_ValueByte::operator+(SBW_Value *val)
{
    sbw_byte v = this->value ? *this->value : 0;
...
SBW_Value *SBW_ValueByte::operator++(sbw_none)
{
...
SBW_Value *SBW_ValueByte::operator++(int)
{
    if (!this->value) return this->OpWithNullError(L"right ++");
    SBW_ValueByte *old = new SBW_ValueByte((*this->value));
    (*this->value)++;
    return old;
}

SBW_Value *SBW_ValueByte::operator-(sbw_none) { if (!this->value) return this->OpWithNullError(L"left -"); return new SBW_ValueShort(-(*this->value)); }
...
SBW_Value *SBW_ValueByte::operator_power(SBW_Value *val)
{
    sbw_byte v = this->value ? *this->value : 0;
...
SBW_Value *SBW_ValueByte::operator_power_eq(SBW_Value *val)
{
    if (!this->value)
        return this->OpWithNullError(L"**=");
...
SBW_Value *SBW_ValueByte::operator~(sbw_none) { if (!this->value) return this->OpWithNullError(L"~"); return new SBW_ValueByte(~(*this->value)); }
...
SBW_Value *SBW_ValueByte::operator!(sbw_none) { if (this->value) return new SBW_ValueBoolean((*this->value) == 0); return new SBW_ValueBoolean(true); }
...
SBW_Value *SBW_ValueByte::operator*(sbw_none) { return new SBW_ValuePointer(this, this->Type()); }

SBW_Value *SBW_ValueByte::operator_convert(sbw_value_type dest_type)
{
    if (this->value)
    {
        switch (dest_type)
        {
            ...
            case VT_TYPE_: return new SBW_ValueType(VT_BYTE_);
...
SBW_Value *SBW_ValueByte::operator_abs(sbw_none) 
{
    if (this->value)
    {
        if (*this->value >= 0) return new SBW_ValueByte(*this->value);
        else return new SBW_ValueByte(-*this->value);
    } else return new SBW_ValueByte((sbw_byte*)0);
}