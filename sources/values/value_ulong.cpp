...
SBW_ValueUlong::SBW_ValueUlong(sbw_ulong val)
{
    this->value = (sbw_ulong*)malloc(sizeof(sbw_ulong));
    (*this->value) = val;
}
...
SBW_ValueUlong::SBW_ValueUlong(sbw_ulong *val)
{
    if (val)
    {
        ...
        this->value = (sbw_ulong*)0;
}

SBW_Value *SBW_ValueUlong::AutoConvert(sbw_value_type dest_type)
{
    if (this->value)
    {
        switch (dest_type)
        {
            ...
            case VT_ANY_: return new SBW_ValueAny(new SBW_ValueUlong(*this->value));
    ...
    else
    {
        switch (dest_type)
        {
            ...
            case VT_ANY_: return new SBW_ValueAny(new SBW_ValueUlong((sbw_ulong*)0));
            default: return this->AutoConvertionError(dest_type);
        }
    }    
}

SBW_Value *SBW_ValueUlong::operator+(sbw_none) { if (!this->value) return this->OpWithNullError(L"left +"); return new SBW_ValueUlong(*this->value); }

SBW_Value *SBW_ValueUlong::operator+(SBW_Value *val)
{
    sbw_ulong v = this->value ? *this->value : 0;
...
SBW_Value *SBW_ValueUlong::operator++(sbw_none)
{
...
SBW_Value *SBW_ValueUlong::operator++(int)
{
    if (!this->value) return this->OpWithNullError(L"right ++");
    SBW_ValueUlong *old = new SBW_ValueUlong((*this->value));
    (*this->value)++;
    return old;
}

SBW_Value *SBW_ValueUlong::operator-(sbw_none) { if (!this->value) return this->OpWithNullError(L"left -"); return new SBW_ValueLong(-(*this->value)); }
...
SBW_Value *SBW_ValueUlong::operator_power(SBW_Value *val)
{
    sbw_ulong v = this->value ? *this->value : 0;
...
SBW_Value *SBW_ValueUlong::operator_power_eq(SBW_Value *val)
{
    if (!this->value)
        return this->OpWithNullError(L"**=");
...
SBW_Value *SBW_ValueUlong::operator~(sbw_none) { if (!this->value) return this->OpWithNullError(L"~"); return new SBW_ValueUlong(~(*this->value)); }
...
SBW_Value *SBW_ValueUlong::operator!(sbw_none) { if (this->value) return new SBW_ValueBoolean((*this->value) == 0); return new SBW_ValueBoolean(true); }
...
SBW_Value *SBW_ValueUlong::operator*(sbw_none) { return new SBW_ValuePointer(this, this->Type()); }

SBW_Value *SBW_ValueUlong::operator_convert(sbw_value_type dest_type)
{
    if (this->value)
    {
        switch (dest_type)
        {
            ...
            case VT_TYPE_: return new SBW_ValueType(VT_ULONG_);
...
SBW_Value *SBW_ValueUlong::operator_abs(sbw_none) { return this->value ? new SBW_ValueUlong(*this->value) : new SBW_ValueUlong((sbw_ulong*)0); }