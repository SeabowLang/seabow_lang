...
SBW_ValueShort::SBW_ValueShort(sbw_short val)
{
    this->value = (sbw_short*)malloc(sizeof(sbw_short));
    (*this->value) = val;
}
...
SBW_ValueShort::SBW_ValueShort(sbw_short *val)
{
    if (val)
    {
        ...
        this->value = (sbw_short*)0;
}

SBW_Value *SBW_ValueShort::AutoConvert(sbw_value_type dest_type)
{
    if (this->value)
    {
        switch (dest_type)
        {
            ...
            case VT_ANY_: return new SBW_ValueAny(new SBW_ValueShort(*this->value));
    ...
    else
    {
        switch (dest_type)
        {
            ...
            case VT_ANY_: return new SBW_ValueAny(new SBW_ValueShort((sbw_short*)0));
            default: return this->AutoConvertionError(dest_type);
        }
    }    
}

SBW_Value *SBW_ValueShort::operator+(sbw_none) { if (!this->value) return this->OpWithNullError(L"left +"); return new SBW_ValueShort(*this->value); }

SBW_Value *SBW_ValueShort::operator+(SBW_Value *val)
{
    sbw_short v = this->value ? *this->value : 0;

    switch (val->Type())
    {
        case VT_BYTE_: return new SBW_ValueInt(v + ((SBW_ValueByte*)val)->Get());
        case VT_UBYTE_: return new SBW_ValueInt(v + ((SBW_ValueUbyte*)val)->Get());
        ...
        case VT_BOOLEAN_: return new SBW_ValueInt(v + ((SBW_ValueBoolean*)val)->Get());
...
SBW_Value *SBW_ValueShort::operator++(sbw_none)
{
...
SBW_Value *SBW_ValueShort::operator++(int)
{
    if (!this->value) return this->OpWithNullError(L"right ++");
    SBW_ValueShort *old = new SBW_ValueShort((*this->value));
    (*this->value)++;
    return old;
}

SBW_Value *SBW_ValueShort::operator-(sbw_none) { if (!this->value) return this->OpWithNullError(L"left -"); return new SBW_ValueInt(-(*this->value)); }
...
SBW_Value *SBW_ValueShort::operator_power(SBW_Value *val)
{
    sbw_short v = this->value ? *this->value : 0;
...
SBW_Value *SBW_ValueShort::operator_power_eq(SBW_Value *val)
{
    if (!this->value)
        return this->OpWithNullError(L"**=");
...
SBW_Value *SBW_ValueShort::operator~(sbw_none) { if (!this->value) return this->OpWithNullError(L"~"); return new SBW_ValueShort(~(*this->value)); }
...
SBW_Value *SBW_ValueShort::operator!(sbw_none) { if (this->value) return new SBW_ValueBoolean((*this->value) == 0); return new SBW_ValueBoolean(true); }
...
SBW_Value *SBW_ValueShort::operator*(sbw_none) { return new SBW_ValuePointer(this, this->Type()); }

SBW_Value *SBW_ValueShort::operator_convert(sbw_value_type dest_type)
{
    if (this->value)
    {
        switch (dest_type)
        {
            ...
            case VT_TYPE_: return new SBW_ValueType(VT_SHORT_);
...
SBW_Value *SBW_ValueShort::operator_abs(sbw_none) 
{
    if (this->value)
    {
        if (*this->value >= 0) return new SBW_ValueShort(*this->value);
        else return new SBW_ValueShort(-*this->value);
    } else return new SBW_ValueShort((sbw_short*)0);
}