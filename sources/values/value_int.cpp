...
SBW_ValueInt::SBW_ValueInt(sbw_int val)
{
    this->value = (sbw_int*)malloc(sizeof(sbw_int));
    (*this->value) = val;
}
...
SBW_ValueInt::SBW_ValueInt(sbw_int *val)
{
    if (val)
    {
        ...
        this->value = (sbw_int*)0;
}

SBW_Value *SBW_ValueInt::AutoConvert(sbw_value_type dest_type)
{
    if (this->value)
    {
        switch (dest_type)
        {
            ...
            case VT_ANY_: return new SBW_ValueAny(new SBW_ValueInt(*this->value));
    ...
    else
    {
        switch (dest_type)
        {
            ...
            case VT_ANY_: return new SBW_ValueAny(new SBW_ValueInt((sbw_int*)0));
            default: return this->AutoConvertionError(dest_type);
        }
    }    
}

SBW_Value *SBW_ValueInt::operator+(sbw_none) { if (!this->value) return this->OpWithNullError(L"left +"); return new SBW_ValueInt(*this->value); }

SBW_Value *SBW_ValueInt::operator+(SBW_Value *val)
{
    sbw_int v = this->value ? *this->value : 0;
...
SBW_Value *SBW_ValueInt::operator++(sbw_none)
{
...
SBW_Value *SBW_ValueInt::operator++(int)
{
    if (!this->value) return this->OpWithNullError(L"right ++");
    SBW_ValueInt *old = new SBW_ValueInt((*this->value));
    (*this->value)++;
    return old;
}

SBW_Value *SBW_ValueInt::operator-(sbw_none) { if (!this->value) return this->OpWithNullError(L"left -"); return new SBW_ValueLong(-(*this->value)); }
...
SBW_Value *SBW_ValueInt::operator_power(SBW_Value *val)
{
    sbw_int v = this->value ? *this->value : 0;
...
SBW_Value *SBW_ValueInt::operator_power_eq(SBW_Value *val)
{
    if (!this->value)
        return this->OpWithNullError(L"**=");
...
SBW_Value *SBW_ValueInt::operator~(sbw_none) { if (!this->value) return this->OpWithNullError(L"~"); return new SBW_ValueInt(~(*this->value)); }
...
SBW_Value *SBW_ValueInt::operator!(sbw_none) { if (this->value) return new SBW_ValueBoolean((*this->value) == 0); return new SBW_ValueBoolean(true); }
...
SBW_Value *SBW_ValueInt::operator*(sbw_none) { return new SBW_ValuePointer(this, this->Type()); }

SBW_Value *SBW_ValueInt::operator_convert(sbw_value_type dest_type)
{
    if (this->value)
    {
        switch (dest_type)
        {
            ...
            case VT_TYPE_: return new SBW_ValueType(VT_INT_);
...
SBW_Value *SBW_ValueInt::operator_abs(sbw_none) 
{ 
    if (this->value)
    {
        if (*this->value >= 0) return new SBW_ValueInt(*this->value);
        else return new SBW_ValueInt(-*this->value);
    } else return new SBW_ValueInt((sbw_int*)0);
}