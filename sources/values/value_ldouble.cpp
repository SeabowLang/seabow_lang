...
SBW_ValueLdouble::SBW_ValueLdouble(sbw_ldouble val)
{
    this->value = (sbw_ldouble*)malloc(sizeof(sbw_ldouble));
    (*this->value) = val;
}
...
SBW_ValueLdouble::SBW_ValueLdouble(sbw_ldouble *val)
{
    if (val)
    {
        ...
        this->value = (sbw_ldouble*)0;
}

SBW_Value *SBW_ValueLdouble::AutoConvert(sbw_value_type dest_type)
{
    if (this->value)
    {
        switch (dest_type)
        {
            ...
            case VT_ANY_: return new SBW_ValueAny(new SBW_ValueLdouble(*this->value));
    ...
    else
    {
        switch (dest_type)
        {
            ...
            case VT_ANY_: return new SBW_ValueAny(new SBW_ValueLdouble((sbw_ldouble*)0));
            default: return this->AutoConvertionError(dest_type);
        }
    }    
}

SBW_Value *SBW_ValueLdouble::operator+(sbw_none) { if (!this->value) return this->OpWithNullError(L"left +"); return new SBW_ValueLdouble(*this->value); }

SBW_Value *SBW_ValueLdouble::operator+(SBW_Value *val)
{
    sbw_ldouble v = this->value ? *this->value : 0;

    switch (val->Type())
    {
        case VT_BYTE_: return new SBW_ValueLdouble(v + ((SBW_ValueByte*)val)->Get());
        case VT_UBYTE_: return new SBW_ValueLdouble(v + ((SBW_ValueUbyte*)val)->Get());
        case VT_SHORT_: return new SBW_ValueLdouble(v + ((SBW_ValueShort*)val)->Get());
        case VT_USHORT_: return new SBW_ValueLdouble(v + ((SBW_ValueUshort*)val)->Get());
        case VT_INT_: return new SBW_ValueLdouble(v + ((SBW_ValueInt*)val)->Get());
        case VT_UINT_: return new SBW_ValueLdouble(v + ((SBW_ValueUint*)val)->Get());
        case VT_LONG_: return new SBW_ValueLdouble(v + ((SBW_ValueLong*)val)->Get());
        case VT_ULONG_: return new SBW_ValueLdouble(v + ((SBW_ValueUlong*)val)->Get());
        ...
        case VT_BOOLEAN_: return new SBW_ValueLdouble(v + ((SBW_ValueBoolean*)val)->Get());
        case VT_CHARACTER_: return new SBW_ValueLdouble(v + ((SBW_ValueCharacter*)val)->Get());
...
SBW_Value *SBW_ValueLdouble::operator++(sbw_none)
{
...
SBW_Value *SBW_ValueLdouble::operator++(int)
{
    if (!this->value) return this->OpWithNullError(L"right ++");
    SBW_ValueLdouble *old = new SBW_ValueLdouble((*this->value));
    (*this->value)++;
    return old;
}
...
SBW_Value *SBW_ValueLdouble::operator_power(SBW_Value *val)
{
    sbw_ldouble v = this->value ? *this->value : 0;
...
SBW_Value *SBW_ValueLdouble::operator_power_eq(SBW_Value *val)
{
    if (!this->value)
        return this->OpWithNullError(L"**=");
...
SBW_Value *SBW_ValueLdouble::operator%(SBW_Value *val)
{
    ...
    switch (val->Type())
    {
        case VT_BYTE_: return new SBW_ValueByte(modulo(v, ((SBW_ValueByte*)val)->Get()));
        case VT_UBYTE_: return new SBW_ValueShort(modulo(v, ((SBW_ValueUbyte*)val)->Get()));
        case VT_SHORT_: return new SBW_ValueShort(modulo(v, ((SBW_ValueShort*)val)->Get()));
        case VT_USHORT_: return new SBW_ValueInt(modulo(v, ((SBW_ValueUshort*)val)->Get()));
        case VT_INT_: return new SBW_ValueInt(modulo(v, ((SBW_ValueInt*)val)->Get()));
        case VT_UINT_: return new SBW_ValueLong(modulo(v, ((SBW_ValueUint*)val)->Get()));
        case VT_LONG_: return new SBW_ValueLong(modulo(v, ((SBW_ValueLong*)val)->Get()));
        case VT_ULONG_: return new SBW_ValueLong(modulo(v, ((SBW_ValueUlong*)val)->Get()));
        ...
        case VT_BOOLEAN_: return new SBW_ValueByte(modulo(v, ((SBW_ValueBoolean*)val)->Get()));
        case VT_CHARACTER_: return new SBW_ValueInt(modulo(v, ((SBW_ValueCharacter*)val)->Get()));
...
SBW_Value *SBW_ValueLdouble::operator%=(SBW_Value *val)
{
    ...
    switch (val->Type())
    {
        case VT_BYTE_: (*this->value) = modulo((*this->value), ((SBW_ValueByte*)val)->Get()); return this;
        case VT_UBYTE_: (*this->value) = modulo((*this->value), ((SBW_ValueUbyte*)val)->Get());
        case VT_SHORT_: (*this->value) = modulo((*this->value), ((SBW_ValueShort*)val)->Get());
        case VT_USHORT_: (*this->value) = modulo((*this->value), ((SBW_ValueUshort*)val)->Get());
        case VT_INT_: (*this->value) = modulo((*this->value), ((SBW_ValueInt*)val)->Get());
        case VT_UINT_: (*this->value) = modulo((*this->value), ((SBW_ValueUint*)val)->Get());
        case VT_LONG_: (*this->value) = modulo((*this->value), ((SBW_ValueLong*)val)->Get());
        case VT_ULONG_: (*this->value) = modulo((*this->value), ((SBW_ValueUlong*)val)->Get());
        ...
        case VT_BOOLEAN_: (*this->value) = modulo((*this->value), ((SBW_ValueBoolean*)val)->Get()); return this;
        case VT_CHARACTER_: (*this->value) = modulo((*this->value), ((SBW_ValueCharacter*)val)->Get()); return this;
...
SBW_Value *SBW_ValueLdouble::operator!(sbw_none) { if (this->value) return new SBW_ValueBoolean((*this->value) == 0); return new SBW_ValueBoolean(true); }
...
SBW_Value *SBW_ValueLdouble::operator*(sbw_none) { return new SBW_ValuePointer(this, this->Type()); }

SBW_Value *SBW_ValueLdouble::operator_convert(sbw_value_type dest_type)
{
    if (this->value)
    {
        switch (dest_type)
        {
            ...
            case VT_STRING_: {
                ...
                stream << std::fixed << std::setprecision(24) << *this->value;
                return new SBW_ValueString(stream.str());
            }
            case VT_TYPE_: return new SBW_ValueType(VT_LDOUBLE_);
...
SBW_Value *SBW_ValueLdouble::operator_abs(sbw_none) 
{
    if (this->value)
    {
        if (*this->value >= 0) return new SBW_ValueLdouble(*this->value);
        else return new SBW_ValueLdouble(-*this->value);
    } else return new SBW_ValueLdouble((sbw_ldouble*)0);
}